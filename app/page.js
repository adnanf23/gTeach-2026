  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-white text-slate-900 font-sans">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center">
        ...
        {/* Heading */}
        <H1 align="center">
          Sistem Manajemen Pembelajaran Terbaru
          <br />
          dengan{" "}
          <span className="bg-gradient-to-br from-blue-700 to-blue-400 bg-clip-text text-transparent">
            gTeach Space
          </span>
        </H1>
        ...
        <Paragraph align="center">
          ...
          hingga perapotan sehingga para guru tidak perlu menjalani proses yang
          kompleks
        </Paragraph>
